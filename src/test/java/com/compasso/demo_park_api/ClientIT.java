...
public class ClientIT {
    ...
    @Test
    public void createClient_WithCpfAlreadyRegistered_ReturnsErrorMessageStatus409() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/clients")
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "tob@email.com", "123456"))
                .bodyValue(new ClientCreateDto("Tobias Ferreira", "06516269009"))
                .exchange()
    ...
    @Test
    public void createClient_WithInvalidFields_ReturnsErrorMessageStatus422() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/clients")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "tob@email.com", "123456"))
                .bodyValue(new ClientCreateDto("BOB", "849.906.610-01"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void createClient_WithUserNotPermitted_ReturnsErrorMessageStatus403() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/clients")
                .contentType(MediaType.APPLICATION_JSON)

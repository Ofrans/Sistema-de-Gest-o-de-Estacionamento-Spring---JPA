...
public class AuthenticationIT {
    ...
    @Test
    public void authenticate_WithInvalidUsername_ReturnTokenWithErrorMessage422() {
        ErrorMessage responseBody =  testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void authenticate_WithInvalidPassword_ReturnTokenWithErrorMessage422() {
        ErrorMessage responseBody =  testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UserLoginDto("ana@email.com", "123456789"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();

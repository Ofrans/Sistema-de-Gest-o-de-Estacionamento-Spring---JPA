...
public class UserIT {
    ...
    public void createUser_WithValidUsernameAndPassword_ReturnUserCreatedWithStatus201(){
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("memphisdepay@gmail.com");
    ...
    @Test
    public void searchUser_WithClientUserSearchAnotherClient_ReturnErroMessageWithStatus203(){
        ErrorMessage responseBody = testClient
                .get()
                .uri("api/v1/users/102")
    ...
    @Test
    public void updatePassword_WithDifferentUsers_ReturnErroMessageWithStatus403(){
        ErrorMessage responseBody = testClient
                .patch()
                .uri("api/v1/users/0")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
    ...
    @Test
    public void listarUsers_WithPermissionUser_ReturnStatus200() {
    ...
    @Test
    public void listUsers_WithNotPermissionUser_RetornarErrorMessageStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/usuarios")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@email.com", "123456"))
